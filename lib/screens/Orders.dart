...
class _OrdersState extends State<Orders> {
  ...
  DatabaseReference orderReference = FirebaseDatabase.instance.reference().child("orders");
  DatabaseReference itemReference = FirebaseDatabase.instance.reference().child("items");
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: (){
            showSaveOrderDialog(Order(0,"","",table.geTableNo(),"","pending",""));
          },
        ),
        appBar: AppBar(
          bottom: TabBar(
                    ...
                    content: Form(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          Container(width: 0,height: 0,margin: EdgeInsets.only(bottom: 15.0),),
                          Row(
                            children: [
                              Expanded(child: Text("Item Type: ")),
                              Expanded(
                                child: DropdownButton(
                                  items: ["Oil","Butter","Cheese"].map((value) {
                                    return DropdownMenuItem(
                                        value: value,
                                        child: Text(value)
                                    );
